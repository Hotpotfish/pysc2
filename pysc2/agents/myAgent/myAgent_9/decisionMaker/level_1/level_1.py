...
from pysc2.agents.myAgent.myAgent_9.decisionMaker.level_1.DQN_for_level_1 import DQN
...
from pysc2.agents.myAgent.myAgent_9.tools import handcraft_function
