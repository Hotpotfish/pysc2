...
from pysc2.agents.myAgent.myAgent_14_COMA.decisionMaker.hierarchical_learning_structure import \
    hierarchical_learning_structure
from pysc2.agents.myAgent.myAgent_14_COMA.tools.plt_function import plt_function
...
class myAgent(base_agent.BaseAgent):
    ...
    def step(self, obs):
        ...
        # action = self.hierarchical_learning_structure.execute(obs, 'TEST', None, 'D:/model/20200215145350/episode_4000')
        # print(action)
        return action
