...
class level_2_build_controller:
    ...
    #     self.controller.current_state = handcraft_function.get_all_observation(obs)
    #     return self.controller.network.action(self.controller.current_state)
    # 
    # def train_network(self,modelSavePath):
    #     self.controller.network.train_Q_network(modelSavePath)
    # 
    # def load_model(self, modelLoadPath):
    #     self.controller.network.restoreModel(modelLoadPath)
    # 
    # def save_model(self,modelSavePath, episode):
    #     self.controller.network.saveModel(modelSavePath, episode)
