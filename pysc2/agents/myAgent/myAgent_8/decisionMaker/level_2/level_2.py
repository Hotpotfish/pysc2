...
class level_2():
    ...
    def train_action(self, obs, controller_number):
        ...
        # if self.controllers[controller_number].controller.previous_action is not None:
        #     self.controllers[controller_number].controller.network.perceive(self.controllers[controller_number].controller.previous_state,
        #                                                          self.controllers[controller_number].controller.previous_action,
        #                                                          self.controllers[controller_number].controller.previous_reward,
        #                                                          self.controllers[controller_number].controller.current_state,
        #                                                          obs.last())
        # action_and_parameter = self.controllers[controller_number].controller.network.egreedy_action(self.controllers[controller_number].controller.current_state)
        # self.controllers[controller_number].controller.previous_reward = obs.reward
        # self.controllers[controller_number].controller.previous_state = self.controllers[controller_number].controller.current_state
        # self.controllers[controller_number].controller.previous_action = action_and_parameter
